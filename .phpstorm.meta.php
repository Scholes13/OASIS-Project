...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.E:\Learning\WGProject\Numbering\public\storage' => 'string',
            ...
            'livewire.performance.update_throttle' => 'integer',
            'livewire.performance.lazy_loading' => 'boolean',
            'livewire.performance.defer_loading' => 'boolean',
...
'auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','boost.enabled','boost.browser_logs_watcher',
...
'filesystems.links.E:\\Learning\\WGProject\\Numbering\\public\\storage','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'livewire.navigate.show_progress_bar','livewire.navigate.progress_bar_color','livewire.inject_morph_markers','livewire.pagination_theme','livewire.performance.update_throttle',
'livewire.performance.lazy_loading','livewire.performance.defer_loading','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','pdf.pdf_method','pdf.browsershot.timeout',
'pdf.browsershot.format','pdf.browsershot.orientation','pdf.browsershot.margins.top','pdf.browsershot.margins.right','pdf.browsershot.margins.bottom',
'pdf.browsershot.margins.left','pdf.browsershot.wait_until_network_idle','pdf.browsershot.enable_javascript','pdf.browsershot.no_sandbox','pdf.browsershot.disable_web_security',
'pdf.browsershot.ignore_https_errors','pdf.dompdf.format','pdf.dompdf.orientation','permission.models.permission','permission.models.role',
...
'debugbar.theme','debugbar.debug_backtrace_limit','activitylog.enabled','activitylog.delete_records_older_than_days','activitylog.default_log_name',
...
'admin.access','role','permission','role_or_permission','livewire.timeout',);
...
'livewire.upload-file','livewire.preview-file','purchase-requests.public',
'purchase-requests.pdf-public','purchase-requests.download-pdf-public','test.browsershot','dashboard','profile',
'purchase-requests.index','purchase-requests.create','purchase-requests.show','purchase-requests.edit','purchase-requests.destroy',
'purchase-requests.resubmit','purchase-requests.void','purchase-requests.pdf','purchase-requests.download-pdf','purchase-requests.all',
'approvals.index','approvals.show','approvals.process','approvals.qr-code','pr-numbers.index',
'pr-numbers.continue','pr-numbers.void','reports.purchase-requests','reports.approvals','admin.dashboard',
'admin.system-health','admin.users.index','admin.users.create','admin.users.store','admin.users.show',
'admin.users.edit','admin.users.update','admin.users.destroy','admin.business-units.departments','admin.departments.positions',
'admin.business-units.index','admin.business-units.create','admin.business-units.store','admin.business-units.show','admin.business-units.edit',
'admin.business-units.update','admin.business-units.destroy','admin.business-units.toggle-status','admin.business-units.configuration','admin.business-units.update-configuration',
'admin.departments.index','admin.departments.create','admin.departments.store','admin.departments.show','admin.departments.edit',
'admin.departments.update','admin.departments.destroy','admin.number-sequences.index','admin.workflows.index','login',
'password.request','password.reset','verification.notice','verification.verify','password.confirm',
'logout','storage.local',);
        registerArgumentsSet('views', 
'admin.business-units.create','admin.business-units.edit','admin.business-units.index','admin.business-units.show','admin.dashboard',
'admin.departments.create','admin.departments.edit','admin.departments.index','admin.departments.show','admin.users.create',
'admin.users.edit','admin.users.index','admin.users.show','approvals.index','approvals.show',
'components.action-message','components.application-logo','components.auth-session-status','components.business-unit-selector','components.danger-button',
'components.dropdown','components.dropdown-link','components.icons.chart-bar','components.icons.check-circle','components.icons.cog',
'components.icons.collection','components.icons.document-text','components.icons.home','components.icons.office-building','components.icons.users',
'components.input-error','components.input-label','components.modal','components.nav-link','components.primary-button',
'components.responsive-nav-link','components.secondary-button','components.text-input','components.toast-notification','dashboard',
'debug.auth','layouts.app','layouts.guest','livewire.components.business-unit-switcher','livewire.dashboard.numbering-stats',
'livewire.dashboard.user-dashboard','livewire.layout.navigation','livewire.layout.sidebar','livewire.layout.user-menu','livewire.modules.purchase-request.create',
...
'pr-numbers.index','profile','purchase-requests.all','purchase-requests.create','purchase-requests.edit',
'purchase-requests.index','purchase-requests.pdf-browser','purchase-requests.public','purchase-requests.show','reports.approvals',
'reports.purchase-requests','volt-livewire::components.business-unit-switcher','volt-livewire::dashboard.numbering-stats','volt-livewire::dashboard.user-dashboard','volt-livewire::layout.navigation',
'volt-livewire::layout.sidebar','volt-livewire::layout.user-menu','volt-livewire::modules.purchase-request.create','volt-livewire::pages.auth.confirm-password','volt-livewire::pages.auth.forgot-password',
...
'volt-livewire::profile.update-password-form','volt-livewire::profile.update-profile-information-form','volt-livewire::welcome.navigation','welcome','laravel-exceptions-renderer::components.card',
...
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','E:.Learning.WGProject.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
