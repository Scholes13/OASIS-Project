...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'approval.thresholds.department_head' => 'integer',
            'approval.thresholds.finance_manager' => 'integer',
            'approval.thresholds.general_manager' => 'integer',
            'approval.thresholds.director' => 'integer',
            'approval.special_categories.it' => 'array',
            'approval.special_categories.vehicle' => 'array',
            'approval.special_category_approvers.it' => 'string',
            'approval.special_category_approvers.vehicle' => 'string',
            'approval.timeouts.escalation_hours' => 'integer',
            'approval.timeouts.auto_approve_days' => 'integer',
            ...
            'filesystems.links.F:\Project\Numbering\public\storage' => 'string',
            ...
            'notification.link_expiry_days' => 'integer',
            'notification.email_timeout' => 'integer',
            'notification.retry_enabled' => 'boolean',
            'notification.max_retries' => 'integer',
            'notification.retry_delay' => 'integer',
            'notification.always_save_to_database' => 'boolean',
            'notification.cache_ttl' => 'integer',
            'notification.templates.approval_requested.subject' => 'string',
            'notification.templates.approval_requested.greeting' => 'string',
            'notification.templates.approval_approved.subject' => 'string',
            'notification.templates.approval_approved.greeting' => 'string',
            'notification.templates.approval_rejected.subject' => 'string',
            'notification.templates.approval_rejected.greeting' => 'string',
            'notification.templates.approval_completed.subject' => 'string',
            'notification.templates.approval_completed.greeting' => 'string',
            'notification.defaults.smtp_host' => 'string',
            'notification.defaults.smtp_port' => 'string',
            'notification.defaults.smtp_encryption' => 'string',
            'notification.defaults.mail_from_address' => 'string',
            'notification.defaults.mail_from_name' => 'string',
            'notification.channels.mail' => 'boolean',
            'notification.channels.database' => 'boolean',
            'notification.channels.sms' => 'boolean',
            'notification.channels.slack' => 'boolean',
            'pdf.pdf_method' => 'string',
            'pdf.browsershot.timeout' => 'integer',
            'pdf.browsershot.format' => 'string',
            'pdf.browsershot.orientation' => 'string',
            'pdf.browsershot.margins.top' => 'integer',
            'pdf.browsershot.margins.right' => 'integer',
            'pdf.browsershot.margins.bottom' => 'integer',
            'pdf.browsershot.margins.left' => 'integer',
            'pdf.browsershot.wait_until_network_idle' => 'boolean',
            'pdf.browsershot.enable_javascript' => 'boolean',
            'pdf.browsershot.no_sandbox' => 'boolean',
            'pdf.browsershot.disable_web_security' => 'boolean',
            'pdf.browsershot.ignore_https_errors' => 'boolean',
            'pdf.dompdf.format' => 'string',
            'pdf.dompdf.orientation' => 'string',
...
'view-reports','view-department-analytics','access-purchasing-admin',);
...
'app.aliases.View','app.aliases.Vite','approval.thresholds.department_head','approval.thresholds.finance_manager','approval.thresholds.general_manager',
'approval.thresholds.director','approval.special_categories.it','approval.special_categories.vehicle','approval.special_category_approvers.it','approval.special_category_approvers.vehicle',
'approval.timeouts.escalation_hours','approval.timeouts.auto_approve_days','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'boost.enabled','boost.browser_logs_watcher','cache.default','cache.stores.array.driver','cache.stores.array.serialize',
...
'filesystems.disks.s3.report','filesystems.links.F:\\Project\\Numbering\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','notification.link_expiry_days','notification.email_timeout',
'notification.retry_enabled','notification.max_retries','notification.retry_delay','notification.always_save_to_database','notification.cache_ttl',
'notification.templates.approval_requested.subject','notification.templates.approval_requested.greeting','notification.templates.approval_approved.subject','notification.templates.approval_approved.greeting','notification.templates.approval_rejected.subject',
'notification.templates.approval_rejected.greeting','notification.templates.approval_completed.subject','notification.templates.approval_completed.greeting','notification.defaults.smtp_host','notification.defaults.smtp_port',
'notification.defaults.smtp_encryption','notification.defaults.mail_from_address','notification.defaults.mail_from_name','notification.channels.mail','notification.channels.database',
'notification.channels.sms','notification.channels.slack','pdf.pdf_method','pdf.browsershot.timeout','pdf.browsershot.format',
'pdf.browsershot.orientation','pdf.browsershot.margins.top','pdf.browsershot.margins.right','pdf.browsershot.margins.bottom','pdf.browsershot.margins.left',
'pdf.browsershot.wait_until_network_idle','pdf.browsershot.enable_javascript','pdf.browsershot.no_sandbox','pdf.browsershot.disable_web_security','pdf.browsershot.ignore_https_errors',
'pdf.dompdf.format','pdf.dompdf.orientation','permission.models.permission','permission.models.role','permission.table_names.roles',
...
'signed','throttle','verified','ensure.business.unit.selected','check.business.unit.access',
'admin.access','purchasing.admin.access','activity.reporting.access','role','permission',
'role_or_permission',);
        registerArgumentsSet('routes', 
'debugbar.openhandler','debugbar.clockwork','debugbar.assets.css','debugbar.assets.js','debugbar.cache.delete',
'debugbar.queries.explain','boost.browser-logs','sanctum.csrf-cookie','api.purchase-requests.index','api.purchase-requests.store',
'api.purchase-requests.show','api.purchase-requests.update','api.purchase-requests.destroy','api.purchase-requests.submit','api.purchase-requests.void',
'api.purchase-requests.workflow-status','api.approvals.index','api.approvals.show','api.approvals.process','api.approvals.approve',
'api.approvals.reject','api.approvals.statistics','api.approvals.history','api.user.profile','api.business-units.index',
'api.departments.index','api.activity.dashboard','api.activity.metrics.business-units','api.activity.metrics.strategic-focus','api.activity.metrics.workload-heatmap',
'api.activity.validations.index','api.activity.validations.approve','api.activity.validations.reject','api.health','api.docs','api.business-unit.switch','api.error-logs.store','api.error-logs.batch',
'purchase-requests.public','purchase-requests.pdf-public','purchase-requests.download-pdf-public','stock-requests.public','stock-requests.pdf-public',
'stock-requests.download-pdf-public','stock-approvals.public.approve','stock-approvals.public.process','approvals.public.approve','approvals.public.process',
'test.browsershot','test.error-logging','docs-help','profile','profile.password',
'dashboard','purchase-requests.index','purchase-requests.create','purchase-requests.store','purchase-requests.show',
'purchase-requests.edit','purchase-requests.update','purchase-requests.destroy','purchase-requests.approve','purchase-requests.reject',
'purchase-requests.resubmit','purchase-requests.void','purchase-requests.mark-offline-approved','purchase-requests.pdf','purchase-requests.download-pdf',
'purchase-requests.all','approvals.index','approvals.show','approvals.process','approvals.qr-code',
'pr-numbers.continue','pr-numbers.void','stock-approvals.index','stock-approvals.show','stock-approvals.process',
'stock-approvals.qr-code','stock-requests.index','stock-requests.create','stock-requests.store','stock-requests.show',
'stock-requests.edit','stock-requests.update','stock-requests.destroy','stock-requests.resubmit','stock-requests.void',
'stock-requests.mark-offline-approved','stock-requests.download-pdf','purchasing.dashboard','purchasing.all-requests','purchasing.admin.dashboard',
'purchasing.admin.tasks','purchasing.admin.tasks.show','purchasing.admin.tasks.claim','purchasing.admin.tasks.start','purchasing.admin.tasks.update-status',
'purchasing.admin.tasks.complete','purchasing.admin.task-history','purchasing.admin.task-history.export','purchasing.admin.department-report','purchasing.admin.consolidated-report',
'purchasing.admin.audit-history','purchasing.admin.department-audit-history','purchasing.admin.personal-task-history','purchasing.admin.management-history','purchasing.admin.sla-settings',
'purchasing.admin.sla-settings.update','sales-crm.activities.index','sales-crm.activities.create','sales-crm.activities.store','sales-crm.activities.show',
'sales-crm.activities.edit','sales-crm.activities.update','sales-crm.activities.destroy','sales-crm.contacts.index','sales-crm.contacts.create',
'sales-crm.contacts.store','sales-crm.contacts.show','sales-crm.contacts.edit','sales-crm.contacts.update','sales-crm.contacts.destroy',
'activity.','activity.dashboard','activity.reporting','activity.reporting.manager','activity.task.index',
'activity.task.create','activity.task.store','activity.task.show','activity.task.edit','activity.task.update',
'activity.task.destroy','activity.backdate.requests','activity.backdate.request.submit','activity.backdate.approvals','activity.backdate.approve',
'activity.backdate.reject','reports.purchase-requests','reports.approvals','admin.dashboard','admin.system-health',
'admin.users.index','admin.users.create','admin.users.store','admin.users.show','admin.users.edit',
'admin.users.update','admin.users.destroy','admin.business-units.departments','admin.departments.positions','admin.business-units.index',
'admin.business-units.create','admin.business-units.store','admin.business-units.show','admin.business-units.edit','admin.business-units.update',
'admin.business-units.destroy','admin.business-units.toggle-status','admin.business-units.configuration','admin.business-units.update-configuration','admin.departments.index',
'admin.departments.create','admin.departments.store','admin.departments.show','admin.departments.edit','admin.departments.update',
'admin.departments.destroy','admin.departments.purchasing-config','admin.pr-categories.index','admin.pr-categories.create','admin.pr-categories.store',
'admin.pr-categories.show','admin.pr-categories.edit','admin.pr-categories.update','admin.pr-categories.destroy','admin.activity-types.index',
'admin.activity-types.create','admin.activity-types.store','admin.activity-types.show','admin.activity-types.edit','admin.activity-types.update',
'admin.activity-types.destroy','admin.sub-activities.index','admin.sub-activities.create','admin.sub-activities.store','admin.sub-activities.show',
'admin.sub-activities.edit','admin.sub-activities.update','admin.sub-activities.destroy','admin.notification-settings.index','admin.notification-settings.update',
'admin.notification-settings.test','admin.notification-settings.statistics','admin.sla-settings.index','admin.sla-settings.update','admin.number-sequences.index',
'admin.workflows.index','login','password.request','password.reset',
'verification.notice','verification.verify','password.confirm','logout',
'storage.local',);
        registerArgumentsSet('views', 
'admin.activity-types.create','admin.activity-types.edit','admin.activity-types.index','admin.business-units.create','admin.business-units.edit',
'admin.business-units.index','admin.business-units.show','admin.dashboard','admin.departments.create','admin.departments.edit',
'admin.departments.index','admin.departments.show','admin.notification-settings.index','admin.pr-categories.create','admin.pr-categories.edit',
'admin.pr-categories.index','admin.sla-settings.index','admin.sub-activities.create','admin.sub-activities.edit','admin.sub-activities.index',
'admin.users.create','admin.users.edit','admin.users.index','admin.users.show','components.action-message',
'components.application-logo','components.auth-session-status','components.business-unit-selector','components.danger-button','components.dropdown',
'components.dropdown-link','components.icons.book-open','components.icons.briefcase','components.icons.chart-bar','components.icons.check-circle',
'components.icons.clipboard-check','components.icons.clipboard-list','components.icons.clock','components.icons.cog','components.icons.collection',
'components.icons.document-text','components.icons.home','components.icons.mail','components.icons.office-building','components.icons.shopping-cart',
'components.icons.tag','components.icons.users','components.input-error','components.input-label','components.loading-skeleton',
'components.loading-spinner','components.modal','components.nav-link','components.primary-button','components.responsive-nav-link',
'components.secondary-button','components.sidebar','components.text-input','components.toast-notification','debug.auth',
'emails.activity.backdate-request-approved','emails.activity.backdate-request-rejected','emails.activity.backdate-request-submitted','emails.layouts.email','emails.purchasing.admin.sla-exceeded',
'emails.purchasing.admin.task-assigned','emails.purchasing.purchase-request.approval-completed','emails.purchasing.purchase-request.approval-rejected','emails.purchasing.purchase-request.approval-requested','emails.purchasing.stock-request.approval-requested',
'layouts.app','layouts.guest','layouts.inertia','purchasing.approvals.purchase-request.index','purchasing.approvals.purchase-request.public-approval',
'purchasing.approvals.purchase-request.public-error','purchasing.approvals.purchase-request.public-success','purchasing.approvals.purchase-request.show','purchasing.approvals.stock-request.public-approval','purchasing.approvals.stock-request.public-error',
'purchasing.approvals.stock-request.public-success','purchasing.purchase-requests.pdf-browser','purchasing.purchase-requests.public','purchasing.purchase-requests.show','purchasing.stock-requests.pdf-browser',
'purchasing.stock-requests.public','reports.approvals','reports.purchase-requests','welcome','laravel-exceptions-renderer::components.badge',
...
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'F:.Project.Numbering.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'PDF_METHOD','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER',
