...
class AuditHistory extends Component
{
    ...
    {
        return \App\Models\Core\User::whereHas('businessUnits', function ($query) {
    ...
    {
        return \App\Models\Core\Department::where('is_purchasing_department', true)
            ->orderBy('name')
            ->get();
    }
    ...
    {
        if (!$this->readyToLoad) {
            return view('livewire.modules.purchasing.admin.audit-history', [
