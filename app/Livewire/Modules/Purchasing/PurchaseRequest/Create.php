...
class Create extends Component
{
    ...
    protected function createCustomApprovalWorkflow(PurchaseRequest $purchaseRequest)
    {
        ...
        foreach ($validApprovals as $index => $approval) {
            ...
            \App\Models\Modules\Purchasing\PurchaseRequest\PrApproval::create([
    ...
    protected function sendApprovalNotifications(PurchaseRequest $purchaseRequest)
    {
        try {
            ...
            if ($purchaseRequest->is_sequential_approval) {
                ...
                if ($approver) {
                    $approver->notify(new \App\Notifications\Purchasing\PurchaseRequest\ApprovalRequested($firstApproval));
                ...
                foreach ($pendingApprovals as $approval) {
                    ...
                    if ($approver) {
                        $approver->notify(new \App\Notifications\Purchasing\PurchaseRequest\ApprovalRequested($approval));
    ...
    public function render()
    {
        try {
            ...
            return view('livewire.modules.purchasing.purchase-request.create', [
