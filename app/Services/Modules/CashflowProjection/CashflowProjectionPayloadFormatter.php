    ...
    public function buildDashboardFinanceInputs(Collection $financeInputs): Collection
    {
        return $financeInputs->map(function (CashflowProjectionFinanceInput $input) {
            return [
                'id' => $input->id,
                'month' => $input->month,
                'cash_on_hand' => CashflowMoney::normalize($input->cash_on_hand),
                'receivable_estimate' => CashflowMoney::normalize($input->receivable_estimate),
                'upcoming_event_revenue_estimate' => CashflowMoney::normalize($input->upcoming_event_revenue_estimate),
                'capital_injection_estimate' => CashflowMoney::normalize($input->capital_injection_estimate),
                'other_income' => CashflowMoney::normalize($input->other_income),
            ];
        })->values();
    }
