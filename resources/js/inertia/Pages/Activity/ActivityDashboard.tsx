...
export default function ActivityDashboard({
    ...
    // Initialize from query params or default
    ...
    const handleTabChange = (tab: 'todo' | 'inprogress' | 'review') => {
        ...
        router.get(
            ...
            { tab, page: 1 },
            { preserveState: true, preserveScroll: true, only: ['personalVisuals', 'queryParams'] }
        );
    };
    ...
    const handleDeptTabChange = (tab: 'todo' | 'inprogress' | 'review') => {
        ...
        router.get(
            route('activity.dashboard'),
            { dept_tab: tab, dept_page: 1 },
            { preserveState: true, preserveScroll: true, only: ['departmentVisuals', 'queryParams'] }
        );
    };
                        ...
                        {viewMode === 'personal' ? (
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div className={cn(
                                        ...
                                        <div>
                                            <p className={cn("text-sm font-semibold", personalStats.overdue > 0 ? "text-red-700" : "text-gray-500")}>
                                                Overdue Tasks
                                            </p>
                                            <p className={cn("text-3xl font-bold mt-1", personalStats.overdue > 0 ? "text-red-700" : "text-gray-900")}>
                                                {personalStats.overdue}
                                            </p>
                                            {personalStats.overdue > 0 && (
                                                <p className="text-xs text-red-600 mt-1 font-medium bg-red-100 px-2 py-0.5 rounded-full inline-block">
                                                    Action Required
                                                </p>
                                            )}
                                        </div>
                                    ...
                                    <div className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-xs text-amber-700 mt-1 font-medium bg-amber-50 px-2 py-0.5 rounded-full inline-block border border-amber-100">
                                                Active Tasks
                                            </p>
                                        </div>
                                        ...
                                        <div className="h-14 w-14 relative flex items-center justify-center">
                                            ...
                                            <svg className="h-full w-full transform -rotate-90">
                                                ...
                                                <circle
                                                    ...
                                                    fill="none"
                                                    strokeDasharray={138}
                                                    strokeDashoffset={138 - (138 * (personalStats.total > 0 ? (personalStats.completed / personalStats.total) : 0))}
                                ...
                                {/* Row 2: Main Content (70% - 30%) - Equal Height Columns */}
                                <div className="grid grid-cols-1 lg:grid-cols-10 gap-6 items-stretch">
                                    {/* Left (70%): My Task Roadmap */}
                                    <div className="lg:col-span-7 bg-white rounded-xl border border-gray-200 shadow-sm flex flex-col">
                                        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                                            ...
                                            {/* Internal Tabs - Now trigger server fetch */}
                                        ...
                                        <div className="p-0 flex-1 overflow-auto max-h-[520px]">
                                            {activeRoadmapList.length > 0 ? (
                                                <table className="w-full text-left">
                                                    <thead className="bg-gray-50 text-xs text-gray-400 uppercase tracking-wider sticky top-0 bg-gray-50 z-10">
                                                        <tr>
                                                ...
                                                <div className="flex flex-col items-center justify-center h-64 text-center">
                                                    ...
                                                    <p className="text-sm text-gray-500 mt-1">Check other tabs or create a new task</p>
                                    ...
                                    {/* Right (30%): Insights & Actions - flex to fill height */}
                                    <div className="lg:col-span-3 flex flex-col gap-6">
                                        {/* Widget 1: Distribution */}
                                        <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                                            ...
                                            <div className="h-[180px] relative">
                                                <ResponsiveContainer width="100%" height="100%">
                                                    <PieChart>
                                                        <Pie
                                                            data={personalVisuals.distribution}
                                                            cx="50%"
                                                            cy="50%"
                                                            innerRadius={55}
                                                            outerRadius={75}
                                                ...
                                                <div className="absolute inset-0 flex items-center justify-center pointer-events-none flex-col">
                                                    <span className="text-2xl font-bold text-gray-900 leading-none">{personalStats.total}</span>
                                                ...
                                                {personalVisuals.distribution?.slice(0, 4).map((d, i) => (
                                                    <div key={i} className="flex items-center justify-between text-xs">
                                                        ...
                                                        <span className="font-medium text-gray-900 bg-gray-50 px-1.5 py-0.5 rounded">
                                                            {personalStats.total > 0 ? Math.round((d.value / personalStats.total) * 100) : 0}%
                                                        </span>
                                                    </div>
                                                ))}
                                            </div>
                                        ...
                                        {/* Widget 2: Upcoming Deadlines - Expands to fill */}
                                            ...
                                            <div className="space-y-3">
                                                {personalVisuals.upcoming?.length > 0 ? (
                                                    personalVisuals.upcoming.map(task => (
                                                        <Link key={task.id} href={route('activity.task.show', task.id)}>
                                                            <div className="flex items-start gap-3 p-2.5 rounded-lg hover:bg-gray-50 transition-all cursor-pointer border border-transparent hover:border-gray-100 group">
                                                                ...
                                                                <div className="min-w-0 flex-1">
                                                                    ...
                                                                    <p className={cn("text-xs font-medium mt-0.5", task.is_critical ? "text-red-500" : "text-gray-400")}>
                                                    ...
                                                    <div className="text-center py-6">
                                                        ...
                                                        <p className="text-xs text-gray-500">No deadlines this week 🎉</p>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm flex items-center justify-between">
                                        <div>
                                            <p className="text-sm font-semibold text-gray-500">Team Overdue</p>
                                            <p className={cn("text-3xl font-bold mt-1", (departmentVisuals?.bottleneck || 0) > 0 ? "text-red-600" : "text-gray-900")}>
                                                {departmentVisuals?.bottleneck || 0}
                                            </p>
                                            {(departmentVisuals?.bottleneck || 0) > 0 ? (
                                                <p className="text-xs text-red-600 mt-1 font-medium bg-red-50 px-2 py-0.5 rounded-full inline-block border border-red-100">
                                                    Needs attention
                                                </p>
                                            ) : (
                                                <p className="text-xs text-emerald-700 mt-1 font-medium bg-emerald-50 px-2 py-0.5 rounded-full inline-block border border-emerald-100">
                                                    All on track
                                                </p>
                                            )}
                                        </div>
                                    ...
                                    <div className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm flex items-center justify-between">
                                        <div>
                                            <p className="text-sm font-semibold text-gray-500">Total Active</p>
                                            <p className="text-3xl font-bold text-gray-900 mt-1">{departmentStats?.total || 0}</p>
                                            <p className="text-xs text-indigo-700 mt-1 font-medium bg-indigo-50 px-2 py-0.5 rounded-full inline-block border border-indigo-100">
                                                Department Tasks
                                            </p>
                                        </div>
                                    ...
                                    <div className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm flex items-center justify-between">
                                        <div>
                                            <p className="text-sm font-semibold text-gray-500">Top Category</p>
                                            <p className="text-2xl font-bold text-gray-900 mt-1 truncate max-w-[180px]" title={departmentVisuals?.top_category}>
                                                {departmentVisuals?.top_category || '-'}
                                            </p>
                                            <p className="text-xs text-gray-500 mt-1">Most active work type</p>
                                        </div>
                                        <div className="p-3 bg-amber-50 rounded-lg border border-amber-100">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-10 gap-6 items-stretch">
                                    {/* Left (70%): Department Task Roadmap */}
                                    <div className="lg:col-span-7 bg-white rounded-xl border border-gray-200 shadow-sm flex flex-col">
                                        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                                            <h2 className="text-lg font-bold text-gray-900 flex items-center gap-2">
                                                <List className="h-5 w-5 text-indigo-600" />
                                            ...
                                            <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <Button
                                                        ...
                                                        size="sm"
                                                        className="h-8 gap-1 px-2 text-xs"
                                                        onClick={() => handleDeptPageChange(deptPagination.prev_page_url)}
                                                        disabled={!deptPagination.prev_page_url}
                                                    >
                                                        <ChevronLeft className="h-3.5 w-3.5" /> Prev
                                                    </Button>
                                                    <Button
                                                        ...
                                                        size="sm"
                                                        className="h-8 gap-1 px-2 text-xs"
                                                        onClick={() => handleDeptPageChange(deptPagination.next_page_url)}
                                                        disabled={!deptPagination.next_page_url}
                                                    >
                                                        Next <ChevronRight className="h-3.5 w-3.5" />
                                                    </Button>
                                                </div>
                                    ...
                                    <div className="lg:col-span-3 flex flex-col gap-6">
                                        ...
                                        <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                                            ...
                                            <div className="h-[180px] relative">
                                                <ResponsiveContainer width="100%" height="100%">
                                                    <PieChart>
                                                        <Pie
                                                            data={departmentVisuals?.distribution || []}
                                                            cx="50%"
                                                            cy="50%"
                                                            innerRadius={55}
                                                            outerRadius={75}
                                                ...
                                                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                                                    <div className="text-center">
                                                        <p className="text-2xl font-bold text-gray-900">{departmentStats?.total || 0}</p>
                                        ...
                                        <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm flex-1 flex flex-col">
                                            ...
                                            <div className="space-y-3">
                                                {departmentVisuals?.upcoming?.length > 0 ? (
                                                    departmentVisuals.upcoming.map((task: any) => (
                                                        <Link href={route('activity.task.show', task.id)} key={task.id} className="block group">
