...
export default function SupportBanner() {
    return (
        <div className="bg-gradient-to-br from-[#eff6ff] to-[#dbeafe] rounded-xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <a
                href="https://request.werkudara.com"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center px-5 py-2.5 bg-[#16599c] text-white rounded-lg text-sm font-medium hover:bg-[#124a82] transition-colors shrink-0"
            >
