...
interface AuditHistoryProps extends PageProps {
    tasks: {
        data: AdminTask[];
        links: any[];
        current_page: number;
...
export default function AuditHistory({ tasks, admins, departments, filters }: AuditHistoryProps) {
    ...
    // Reset filters
    const resetFilters = () => {
        const reset = { date_from: '', date_to: '', status: 'all', type: 'all', admin: 'all', department: 'all' };
        setLocalFilters(reset);
        router.get(route('purchasing.admin.audit-history'), reset, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    const handleFilterChange = (key: string, value: string) => {
        ...
        router.get(route('purchasing.admin.audit-history'), newFilters, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    const goToPage = (page: number) => {
        router.get(route('purchasing.admin.audit-history'), { ...localFilters, page }, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    return (
        <>
            <Head title="Audit History - Super Admin" />
            <div className="py-6">
                <div className="w-full px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500">Complete audit trail of all admin tasks across all business units</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl border border-gray-100 overflow-hidden shadow-sm">
                        ...
                        <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                            <div>
                                <h3 className="text-base font-semibold text-gray-900">All Tasks Audit</h3>
                                <p className="text-sm text-gray-500">Super Admin view - all business units</p>
                            </div>
                            <button
