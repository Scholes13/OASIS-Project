...
export default function TaskHistory({ tasks, statistics, filters }: TaskHistoryProps) {
    ...
    // Apply filters
    const applyFilters = () => {
        router.get(route('purchasing.admin.task-history'), localFilters, {
            preserveState: true,
            preserveScroll: true,
        });
    };
                        ...
                        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{formatTime(statistics.avg_followup_time)}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{formatTime(statistics.avg_completion_time)}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-emerald-600">{formatCurrency(statistics.total_savings)}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div className="relative group">
                                    <button className="inline-flex items-center px-3 py-1.5 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-md transition-colors border border-gray-200">
