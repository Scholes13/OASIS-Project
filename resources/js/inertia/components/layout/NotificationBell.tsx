    ...
    return (
        <div className="relative">
            <button
                ...
                className={cn(
                    'relative inline-flex h-10 w-10 items-center justify-center rounded-xl border border-gray-200 bg-white text-gray-600 transition hover:border-gray-300 hover:text-gray-900',
                    hasNewNotification && 'ring-2 ring-blue-400 ring-offset-1',
                )}
            >
                <Bell className={cn('h-4 w-4', hasNewNotification && 'animate-wiggle')} />
                {unreadCount > 0 ? (
