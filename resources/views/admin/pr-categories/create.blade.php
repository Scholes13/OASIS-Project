<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Create PR Category</h1>
                <p class="text-sm text-gray-600 mt-1">Add a new purchase request category</p>
            </div>
    ...
    <div class="max-w-2xl">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <form action="{{ route('admin.pr-categories.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
