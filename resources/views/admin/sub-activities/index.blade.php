    ...
    <div class="w-full">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
            <form method="GET" action="{{ route('admin.sub-activities.index') }}" class="flex flex-wrap gap-4">
                <div class="w-48">
                    <select name="activity_type" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center text-gray-500">
                                    No sub-activities found. <a href="{{ route('admin.sub-activities.create', request()->only('activity_type')) }}" class="text-indigo-600 hover:text-indigo-900">Create one</a>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
