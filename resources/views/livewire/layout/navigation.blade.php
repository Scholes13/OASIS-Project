...
<nav x-data="{ 
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('purchasing.dashboard') }}" wire:navigate>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('purchasing.dashboard')" :active="request()->routeIs('purchasing.dashboard')" wire:navigate>
                        {{ __('Dashboard') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('purchasing.dashboard')" :active="request()->routeIs('purchasing.dashboard')" wire:navigate>
                {{ __('Dashboard') }}
