    ...
    <div class="bg-white rounded-xl border border-gray-100 overflow-hidden">
        ...
        <div class="px-5 py-4 border-b border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-base font-semibold text-gray-900">Audit History - All Business Units</h3>
                    <p class="text-sm text-gray-500 mt-1">Complete task history across all business units</p>
                </div>
        ...
        <div class="px-5 py-4 bg-gray-50 border-b border-gray-100">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
                ...
                <div>
                    ...
                    <select wire:model.live="departmentFilter" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    ...
                    @empty
                        <tr>
                            <td colspan="14" class="px-5 py-8 text-center text-sm text-gray-500">
