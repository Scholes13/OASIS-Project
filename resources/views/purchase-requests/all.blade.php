...
<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">All Purchase Requests</h1>
    ...
    <x-slot name="breadcrumbs">
        ...
        <li class="flex">
            <div class="flex items-center">
                ...
                <span class="ml-4 text-sm font-medium text-gray-500">All Purchase Requests</span>
            </div>
        </li>
    </x-slot>
        ...
        @if($purchaseRequests->count() > 0)
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">All Purchase Requests</h3>
                            <p class="text-sm text-gray-600 mt-1">{{ $purchaseRequests->total() }} total requests</p>
                        </div>
                        <!-- TODO: Add filters and search -->
                        <div class="flex items-center space-x-2">
                            <span class="text-sm text-gray-500">Filters coming soon</span>
                        </div>
                    </div>
                </div>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            @if($pr->canBeEdited() && $pr->user_id === Auth::id())
