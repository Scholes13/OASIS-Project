        ...
        <div class="approval-grid">
            ...
            <div class="approval-box creator-box">
                ...
                <div class="qr-code-container">
                    <img src="{{ $qrCodes['requestor'] }}" alt="QR Code" style="width: 60px; height: 60px;">
                </div>
                @else
            ...
            @for($i = 0; $i < $maxApprovals; $i++)
                ...
                <div class="approval-box">
                    ...
                    @endphp
                    <div class="approval-title">{{ $isAcknowledge ? 'Acknowledged by' : 'Approved by' }}</div>
                    
                    @if($approval && $approval->status === 'approved')
                        <div class="qr-code-container">
                            <img src="{{ $qrCodes['approvals'][$approval->id] ?? $qrCodes['requestor'] }}" alt="Approval QR Code" style="width: 60px; height: 60px;">
                        </div>
