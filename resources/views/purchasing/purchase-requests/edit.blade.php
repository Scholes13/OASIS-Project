<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Edit Purchase Request</h1>
                <p class="text-sm text-gray-600 mt-1">
                    Update draft PR <span class="font-semibold text-gray-800">{{ $purchaseRequest->pr_number }}</span>
                    for {{ $purchaseRequest->businessUnit->name ?? session('current_business_unit_name') }}
                </p>
            </div>
    ...
    <x-slot name="breadcrumbs">
        ...
        <li class="flex">
            <div class="flex items-center">
                ...
                <span class="ml-4 text-sm font-medium text-gray-500">Edit Draft</span>
            </div>
        </li>
    </x-slot>

    <livewire:modules.purchasing.purchase-request.create :purchase-request="$purchaseRequest" mode="edit" />
</x-app-layout>
