                        ...
                        <tbody class="bg-white">
                            @foreach($allItems as $item)
                                <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="text-sm font-medium text-gray-900">{{ $item['department']->code ?? 'N/A' }}</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm font-medium text-gray-900">{{ $item['pr_number'] }}</div>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900 max-w-md" title="{{ $item['purpose'] }}">
                                            {{ Str::limit($item['purpose'], 60) }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-right">
                                        @if($item['type'] === 'purchase_request')
                                            <div class="text-sm font-medium text-gray-900">
                                                {{ $item['data']->currency }} {{ number_format($item['data']->total_amount, 0, ',', ',') }}
                                            </div>
                                        @else
                                    ...
                                    <td class="px-6 py-4">
                                        @php
                                            $statusConfig = [
                                                ...
                                                'in_approval' => ['bg' => 'bg-yellow-100', 'text' => 'text-yellow-700', 'label' => 'In Approval'],
                                        ...
                                        @endphp
                                        <span class="inline-flex items-center px-2.5 py-1 rounded text-xs font-medium {{ $config['bg'] }} {{ $config['text'] }}">
                                            {{ $config['label'] }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4">
