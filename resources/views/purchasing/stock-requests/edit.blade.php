<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Edit Stock Request</h1>
                <p class="text-sm text-gray-600 mt-1">Update stock request {{ $stockRequest->st_number }}</p>
            </div>
            <div class="flex items-center space-x-3">
                <a href="{{ route('stock-requests.show', $stockRequest->id) }}" 
                   wire:navigate
    ...
    <x-slot name="breadcrumbs">
        <li class="flex">
            <div class="flex items-center">
                <a href="{{ route('purchasing.dashboard') }}" wire:navigate class="text-gray-400 hover:text-gray-500">
        ...
        <li class="flex">
            <div class="flex items-center">
                ...
                <a href="{{ route('stock-requests.show', $stockRequest->id) }}" wire:navigate class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">
    ...
    <!-- Stock Request Edit Form -->
    <livewire:modules.purchasing.stock-request.create :stockRequest="$stockRequest" mode="edit" />
</div>
</x-app-layout>
