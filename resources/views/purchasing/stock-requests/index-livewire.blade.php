        ...
        <div class="w-full">
            <div class="border-b border-gray-200 px-6 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-xl font-semibold text-gray-900">My Stock Requests</h1>
                        <p class="text-sm text-gray-500 mt-0.5">{{ session('current_business_unit_name') }}</p>
                    </div>
                    <div class="flex items-center space-x-3">
                        <a href="{{ route('stock-requests.create') }}" wire:navigate
            ...
            <livewire:modules.purchasing.stock-request.my-stock-requests />
        </div>
    </div>
</x-app-layout>
