...
<head>
    ...
    <title>Stock Request - {{ $stockRequest->st_number }}</title>
    <style>
        /* Global Styles */
        * {
            margin: 0;
...
<body>
    ...
    <table class="pdf-header">
        <tr>
            ...
            <td class="logo-section">
                @if($stockRequest->businessUnit && $stockRequest->businessUnit->logo)
                    <img src="{{ asset('storage/' . $stockRequest->businessUnit->logo) }}" alt="{{ $stockRequest->businessUnit->name }} Logo" class="business-logo">
                @else
        ...
        <div class="offline-info-box">
            ...
            <div class="info-content">
                ...
                <div class="info-detail">
                    Diverifikasi oleh <strong>{{ $stockRequest->offlineApprovedBy?->name ?? 'Unknown' }}</strong> 
                    pada <strong>{{ $stockRequest->offline_approved_at?->format('d M Y, H:i') ?? '-' }}</strong>
        ...
        <div class="basic-info-grid">
            ...
            <div class="info-column left-column">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-colon">:</span>
                        <span class="info-value">{{ (int) substr(strrchr($stockRequest->st_number, '/'), 1) }}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Date of Request</span>
                        <span class="info-colon">:</span>
                        <span class="info-value">{{ \Carbon\Carbon::parse($stockRequest->date_of_request)->format('d-M-y') }}</span>
                    </div>
            </div>
            ...
            <div class="info-column right-column">
                    <div class="info-row">
                        ...
                        <span class="info-colon">:</span>
                        <span class="info-value wide">{{ $stockRequest->purpose }}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Designated Date</span>
                        <span class="info-colon">:</span>
                        <span class="info-value">{{ $stockRequest->expected_date ? \Carbon\Carbon::parse($stockRequest->expected_date)->format('d-M-y') : 'N/A' }}</span>
                    </div>
            </div>
        </div>
    </div>
    ...
    <div class="approval-section">
        ...
        <div class="approval-container">
            ...
            <div class="approval-box">
                ...
                @if($stockRequest->submitted_at && isset($qrCodes['requestor']))
    ...
    <div class="pdf-footer">
        <p>This document was generated on {{ now()->format('d F Y, H:i') }} | Stock Request System v1.0</p>
    </div>
</body>
</html>
