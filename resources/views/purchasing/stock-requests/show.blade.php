                ...
                <div class="fixed inset-0 z-10 flex items-center justify-center p-4">
                    <div x-show="showOfflineModal"
                         ...
                         style="width: 100%; max-width: 28rem;"
                            ...
                            <form action="{{ route('stock-requests.mark-offline-approved', $stockRequest) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <!-- Body -->
                                <div class="bg-white px-5 py-4">
                                    <div class="flex items-start">
                                    ...
                                    <div class="mt-3" x-data="{ fileName: '', hasFile: false }">
                                        <label for="st_offline_approval_document" style="font-size: 0.8125rem;" class="block font-medium text-gray-700">
                                        ...
                                        <div class="mt-1">
                                            <label class="cursor-pointer block">
                                                <input type="file" 
                                                       ...
                                                       id="st_offline_approval_document"
                                    ...
                                    <div class="mt-3">
                                        <label for="st_offline_notes" style="font-size: 0.8125rem;" class="block font-medium text-gray-700">Notes (optional)</label>
                                        <textarea name="notes" id="st_offline_notes" rows="2"
                                                  style="font-size: 0.8125rem;"
