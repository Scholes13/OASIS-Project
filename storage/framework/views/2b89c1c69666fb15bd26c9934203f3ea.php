        ...
        <div class="basic-info-grid">
            ...
            <div class="info-column right-column">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-colon">:</span>
                        <span class="info-value"><?php echo e($purchaseRequest->expected_date ? \Carbon\Carbon::parse($purchaseRequest->expected_date)->format('d-M-y') : 'N/A'); ?></span>
                    </div>
            </div>
        </div>
    </div>
            ...
            <?php $__currentLoopData = $approvals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $approval): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="approval-box <?php echo e($loop->last ? 'last-approval' : ''); ?>">
                    ...
                    <?php if($approval->status === 'approved'): ?>
                        <div class="qr-code-container">
                            <img src="<?php echo e($qrCodes['approvals'][$approval->id] ?? $qrCodes['requestor']); ?>" alt="Approval QR Code" style="width: 50px; height: 50px;">
                        </div>
                    <?php else: ?>
                        <div class="qr-code-container empty">&nbsp;</div>
                    <?php endif; ?>
