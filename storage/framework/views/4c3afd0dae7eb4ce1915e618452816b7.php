     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Create a new purchase request for <?php echo e(session('current_business_unit_name')); ?></p>
            </div>
            ...
            <div class="flex items-center">
                <a href="<?php echo e(route('dashboard')); ?>" wire:navigate class="text-gray-400 hover:text-gray-500">
                    <svg class="flex-shrink-0 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2 2z"></path>
                    </svg>
...
[$__name, $__params] = $__split('modules.wns.purchase-requests.create', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-1702582309-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?><?php /**PATH E:\Learning\WGProject\Numbering\resources\views/purchase-requests/create.blade.php ENDPATH**/ ?>