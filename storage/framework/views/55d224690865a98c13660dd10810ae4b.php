...
<div class="w-full space-y-6">
    ...
    <div class="bg-white border border-gray-200" style="display: block !important; visibility: visible !important;">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="text-xs text-gray-500 mt-1">Debug: Section is rendering (user: <?php echo e($user_name); ?>, dept: <?php echo e($department_name); ?>)</p>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        </div>
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between py-2 px-3 bg-gray-50 border border-gray-200">
                            ...
                            <span class="text-sm text-gray-900"><?php echo e($submission_date ?? now()->format('d/m/Y')); ?></span>
                        </div>
                        <div class="flex justify-between py-2 px-3 bg-gray-50 border border-gray-200">
                            <span class="text-sm text-gray-600">Requested By:</span>
                            <span class="text-sm text-gray-900"><?php echo e($user_name ?? 'Unknown User'); ?></span>
                        </div>
                        <div class="flex justify-between py-2 px-3 bg-gray-50 border border-gray-200">
                            <span class="text-sm text-gray-600">Department:</span>
                            <span class="text-sm text-gray-900"><?php echo e($department_name ?? 'Department not set'); ?> (<?php echo e($department_code ?? 'N/A'); ?>)</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <!--[if BLOCK]><![endif]--><?php if(count($items ?? []) > 0): ?>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr wire:key="item-row-<?php echo e($index); ?>" class="hover:bg-gray-50">
                                        <!-- NO -->
                                        ...
                                        <td class="px-3 py-3">
                                            <input 
                                                wire:model.blur="items.<?php echo e($index); ?>.item_name" 
                                                type="text"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <td class="px-3 py-3">
                                            <input 
                                                wire:model.blur="items.<?php echo e($index); ?>.brand_name" 
                                                type="text"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <td class="px-3 py-3">
                                            <input 
                                                wire:model.blur="items.<?php echo e($index); ?>.item_description" 
                                                type="text"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <td class="px-3 py-3">
                                            <input 
                                                wire:model.blur="items.<?php echo e($index); ?>.supplier_name" 
                                                type="text"
                                                class="w-full min-w-28 px-3 py-2 text-sm border border-gray-300 focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <td class="px-3 py-3">
                                        <select 
                                            wire:model.blur="items.<?php echo e($index); ?>.unit" 
                                            class="w-full px-3 py-2 text-sm border border-gray-300 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-center">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $customApprovalList ?? [['approver_id' => '', 'task_type' => 'approval']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $approvalItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div wire:key="approval-item-<?php echo e($index); ?>" class="border border-gray-200 p-4 bg-gray-50">
...
unset($__errorArgs, $__bag); ?>">
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = ($availableApprovers ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $approver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($approver['id'] ?? ''); ?>">
                                                        <?php echo e(($approver['name'] ?? 'Unknown')); ?> - <?php echo e(ucfirst(str_replace('_', ' ', ($approver['role'] ?? 'staff')))); ?> (<?php echo e(($approver['department'] ?? 'No Department')); ?>)
                                                    </option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                            </select>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <div class="flex justify-between items-center pt-6 border-t border-gray-200">
        <button 
            ...
            <?php echo e(($isEdit ?? false) ? 'Update Draft' : 'Save as Draft'); ?>
        ...
        <div class="flex items-center space-x-3">
            ...
            <button 
                ...
                <!--[if BLOCK]><![endif]--><?php if($isEdit ?? false): ?>
                    <!--[if BLOCK]><![endif]--><?php if($this->isRejected ?? false): ?>
...
</style><?php /**PATH E:\Learning\WGProject\Numbering\resources\views/livewire/modules/purchase-request/create.blade.php ENDPATH**/ ?>