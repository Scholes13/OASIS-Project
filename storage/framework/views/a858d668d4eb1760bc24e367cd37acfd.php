    ...
    <div class="space-y-6 max-w-none">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 lg:p-6 hover:shadow-lg hover:border-blue-300 transition-all duration-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1 min-w-0">
                        ...
                        <p class="text-2xl lg:text-3xl font-bold text-gray-900"><?php echo e($stats['total_users']); ?></p>
                        <p class="text-xs text-gray-500"><?php echo e($stats['active_users']); ?> active</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 lg:p-6 hover:shadow-lg hover:border-emerald-300 transition-all duration-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1 min-w-0">
                        ...
                        <p class="text-2xl lg:text-3xl font-bold text-gray-900"><?php echo e($stats['total_business_units']); ?></p>
                        <p class="text-xs text-gray-500"><?php echo e($stats['active_business_units']); ?> active</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 lg:p-6 hover:shadow-lg hover:border-amber-300 transition-all duration-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1 min-w-0">
                        ...
                        <p class="text-2xl lg:text-3xl font-bold text-gray-900"><?php echo e($stats['total_departments']); ?></p>
                        <p class="text-xs text-gray-500"><?php echo e($stats['total_assignments']); ?> assignments</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 lg:p-6 hover:shadow-lg hover:border-purple-300 transition-all duration-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1 min-w-0">
                        ...
                        <p class="text-2xl lg:text-3xl font-bold text-gray-900"><?php echo e($stats['super_admins']); ?></p>
        ...
        <div class="grid grid-cols-1 gap-6 xl:grid-cols-2">
                            ...
                            <div class="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <div class="text-right flex-shrink-0">
                                    <div class="flex flex-wrap gap-1 justify-end mb-1">
                                        <?php $__currentLoopData = $user->activeBusinessUnits->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if($user->activeBusinessUnits->count() > 2): ?>
                                            <span class="text-xs text-gray-500 font-medium">+<?php echo e($user->activeBusinessUnits->count() - 2); ?></span>
                                        <?php endif; ?>
                                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow duration-200">
                ...
                <div class="p-4 lg:p-6">
                    <div class="space-y-5">
                        <?php $__currentLoopData = $businessUnitStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="group">
                                <div class="flex justify-between items-center mb-2">
                                    <span class="text-sm font-semibold text-gray-700 group-hover:text-gray-900 transition-colors duration-200"><?php echo e($bu->name); ?></span>
                                    <div class="flex items-center space-x-2">
                                        <span class="text-sm font-medium text-gray-900"><?php echo e($bu->user_count); ?></span>
                                        <span class="text-xs text-gray-500">users</span>
                                    </div>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                                    <div class="h-3 rounded-full transition-all duration-500 ease-out <?php echo e($index % 4 == 0 ? 'bg-gradient-to-r from-blue-500 to-blue-600' :
                                        ($index % 4 == 1 ? 'bg-gradient-to-r from-emerald-500 to-green-600' :
                                        ($index % 4 == 2 ? 'bg-gradient-to-r from-amber-500 to-yellow-600' :
                                        'bg-gradient-to-r from-purple-500 to-indigo-600'))); ?>" 
                                         style="width: <?php echo e($stats['total_assignments'] > 0 ? ($bu->user_count / $stats['total_assignments']) * 100 : 0); ?>%"></div>
                                </div>
                                <div class="mt-1 text-right">
                                    <span class="text-xs text-gray-400">
                                        <?php echo e($stats['total_assignments'] > 0 ? round(($bu->user_count / $stats['total_assignments']) * 100, 1) : 0); ?>%
                                    </span>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?><?php /**PATH E:\Learning\WGProject\Numbering\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>