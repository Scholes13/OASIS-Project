<div>
    ...
    <!--[if BLOCK]><![endif]--><?php if(count($businessUnits) > 1 && $hasParentAccess): ?>
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm text-gray-600 mb-3">
                        You have access to <strong><?php echo e(count($businessUnits)); ?> business units</strong>. 
                        Click to switch view:
                    </p>
                    <div class="flex flex-wrap gap-2 mb-2">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $businessUnits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <button 
                                type="button"
                                wire:click="switchBusinessUnit(<?php echo e($bu['id']); ?>)"
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($isParent): ?>
                                    <svg class="w-4 h-4 mr-1.5 <?php echo e($isActive ? 'text-white' : 'text-indigo-600'); ?>" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z"></path>
                                    </svg>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <span class="font-bold"><?php echo e($bu['code']); ?></span>
                                <span class="mx-1.5">-</span>
                                <span><?php echo e($bu['name']); ?></span>
                    ...
                    <p class="text-xs text-gray-500 italic flex items-center">
                        ...
                        Currently viewing: <strong class="ml-1 text-indigo-700"><?php echo e(collect($businessUnits)->firstWhere('id', $activeBusinessUnitId)['name'] ?? 'N/A'); ?></strong>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="mb-6 bg-white rounded-xl shadow-sm border border-gray-200 p-4 lg:p-6">
        <div class="flex flex-col lg:flex-row lg:items-end gap-4">
            ...
            <!--[if BLOCK]><![endif]--><?php if($customRange): ?>
                <div class="flex-1">
            ...
            <div class="text-sm text-gray-600" wire:ignore.self>
                <strong>Period:</strong> <?php echo e(date('M j, Y', strtotime($startDate))); ?> - <?php echo e(date('M j, Y', strtotime($endDate))); ?>
                ...
                <div class="ml-4 flex-1 min-w-0">
                    ...
                    <div wire:loading.remove wire:target="switchBusinessUnit,handleBusinessUnitSwitch">
                        <p class="text-2xl lg:text-3xl font-bold text-gray-900">
                            <?php echo e($stats['active_prs'] ?? 0); ?>

                        </p>
                        <p class="text-xs text-gray-500"><?php echo e($stats['draft_prs'] ?? 0); ?> drafts</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="group bg-white rounded-xl shadow-sm border border-gray-200 p-4 lg:p-6 hover:shadow-lg hover:border-orange-300 transition-all duration-200 transform hover:scale-[1.02]">
            <div class="flex items-center">
                ...
                <div class="ml-4 flex-1 min-w-0">
                    ...
                    <div wire:loading.remove wire:target="switchBusinessUnit,handleBusinessUnitSwitch">
                        <p class="text-2xl lg:text-3xl font-bold text-gray-900">
                            <?php echo e($stats['pending_approvals'] ?? 0); ?>

                        </p>
                        <p class="text-xs text-gray-500">
                            <!--[if BLOCK]><![endif]--><?php if(($stats['overdue_approvals'] ?? 0) > 0): ?>
                                <span class="text-red-600 font-semibold"><?php echo e($stats['overdue_approvals']); ?> overdue</span>
                            <?php else: ?>
        ...
        <div class="group bg-white rounded-xl shadow-sm border border-gray-200 p-4 lg:p-6 hover:shadow-lg hover:border-green-300 transition-all duration-200 transform hover:scale-[1.02]">
            <div class="flex items-center">
                ...
                <div class="ml-4 flex-1 min-w-0">
                    ...
                    <div wire:loading.remove wire:target="switchBusinessUnit,handleBusinessUnitSwitch">
                        <p class="text-2xl lg:text-3xl font-bold text-gray-900">
                            <?php echo e($stats['period_prs'] ?? 0); ?>

                        </p>
                        <p class="text-xs text-gray-500">
                            <?php echo e($stats['approved_prs'] ?? 0); ?> approved, <?php echo e($stats['rejected_prs'] ?? 0); ?> rejected
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="group bg-white rounded-xl shadow-sm border border-gray-200 p-4 lg:p-6 hover:shadow-lg hover:border-purple-300 transition-all duration-200 transform hover:scale-[1.02]">
            <div class="flex items-center">
                ...
                <div class="ml-4 flex-1 min-w-0">
                    ...
                    <div wire:loading.remove wire:target="switchBusinessUnit,handleBusinessUnitSwitch">
                        <p class="text-2xl lg:text-3xl font-bold text-gray-900">
                            Rp <?php echo e(number_format($stats['total_amount'] ?? 0, 0, ',', '.')); ?>
    ...
    <div class="grid grid-cols-1 gap-6 xl:grid-cols-2">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow duration-200">
            ...
            <div class="p-4 lg:p-6">
                <div class="flow-root">
                    <!--[if BLOCK]><![endif]--><?php if(count($recentActivities) > 0): ?>
                        <ul class="-mb-8">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <div class="relative <?php echo e($index < count($recentActivities) - 1 ? 'pb-8' : ''); ?>">
                                        <!--[if BLOCK]><![endif]--><?php if($index < count($recentActivities) - 1): ?>
                                            <span class="absolute top-4 left-4 -ml-px h-full w-0.5 bg-gray-200" aria-hidden="true"></span>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <div class="relative flex space-x-3">
                                            <div>
                                                <span class="h-8 w-8 rounded-full bg-<?php echo e($activity['color']); ?>-500 flex items-center justify-center ring-8 ring-white">
                                                    <!--[if BLOCK]><![endif]--><?php if($activity['icon'] === 'check'): ?>
                                            ...
                                            <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                                <div>
                                                    <p class="text-sm text-gray-500"><?php echo $activity['message']; ?></p>
                                                </div>
                                                <div class="text-right text-sm whitespace-nowrap text-gray-500">
                                                    <time><?php echo e(\Carbon\Carbon::parse($activity['created_at'])->diffForHumans()); ?></time>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow duration-200">
            ...
            <div class="p-4 lg:p-6">
                <div class="space-y-3">
                    <a href="<?php echo e(route('pr-numbers.index')); ?>" class="group block p-4 rounded-xl border border-gray-200 hover:border-indigo-300 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-blue-50 transition-all duration-200 transform hover:scale-[1.02]">
                    ...
                    <a href="<?php echo e(route('purchase-requests.index')); ?>" class="group block p-4 rounded-xl border border-gray-200 hover:border-blue-300 hover:bg-gradient-to-r hover:from-blue-50 hover:to-cyan-50 transition-all duration-200 transform hover:scale-[1.02]">
                        <div class="flex items-center space-x-3">
                            <div class="flex-shrink-0">
    ...
    <?php if (! $__env->hasRenderedOnce('f0e06674-4e64-41f3-8be8-a1ebfc1d046b')): $__env->markAsRenderedOnce('f0e06674-4e64-41f3-8be8-a1ebfc1d046b'); ?>
    ...
    <script>
        document.addEventListener('livewire:init', () => {
            ...
            if (typeof Chart !== 'undefined') {
                initializeCharts(<?php echo json_encode($chartData, 15, 512) ?>);
            } else {
...
<?php /**PATH E:\Learning\WGProject\Numbering\resources\views/livewire/dashboard/user-dashboard.blade.php ENDPATH**/ ?>