...
<div class="min-h-screen flex relative" 
    ...
    <div class="absolute top-3.5 left-3.5 sm:top-5 sm:left-5 z-50 flex items-center gap-2 sm:gap-3">
        <img src="<?php echo e(asset('storage/business-units/aDNLhQNtI0R0KiPTv6oFWC2NwLu11tewYoJwjhTg.png')); ?>" 
             alt="Werkudara Logo" 
                ...
                <!--[if BLOCK]><![endif]--><?php if(session('status')): ?>
                    <div class="mb-6 bg-green-50 border border-green-200 rounded-lg p-4">
                        <div class="flex items-center">
                            ...
                            <span class="text-green-800 text-sm font-medium"><?php echo e(session('status')); ?></span>
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="mt-6 sm:mt-8 text-center">
                <p class="text-xs text-gray-500">
                    © <?php echo e(date('Y')); ?> OASIS. Secure office administration system.
                </p>
            </div>
        </div>
    </div>
...
</script><?php /**PATH E:\Learning\WGProject\Numbering\resources\views\livewire/pages/auth/login.blade.php ENDPATH**/ ?>